...
# HR Team Agents Installer
# Copies shared + hr_team agent files to ~/.config/opencode/agent/
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    echo ""
    echo "✓ HR Team agents installed successfully!"
    echo ""
    echo "Next steps:"
    ...
    echo "  4. Start with: @hr_orchestrator: <your task>"
else
