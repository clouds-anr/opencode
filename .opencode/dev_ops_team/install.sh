...
# DevOps Team Agents Installer
# Copies shared + dev_ops_team agent files to ~/.config/opencode/agent/
...
echo "DevOps Team Agents Installer"
echo "============================"
echo ""
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    echo ""
    echo "✓ DevOps Team agents installed successfully!"
    echo ""
    echo "Next steps:"
    ...
    echo "  4. Start with: @devops_orchestrator: <your task>"
else
