...
# Tech Team Agents Installer
# Copies shared + tech_team agent files to ~/.config/opencode/agent/
...
echo "Tech Team Agents Installer"
echo "=========================="
echo ""
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    echo ""
    echo "✓ Tech Team agents installed successfully!"
    echo ""
    echo "Next steps:"
    ...
    echo "  4. Start with: @tech_orchestrator: <your task>"
else
