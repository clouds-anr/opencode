...
# CSP Team Agents Installer
# Copies shared + csp_team agent files to ~/.config/opencode/agent/
...
echo "CSP Team Agents Installer"
echo "========================="
echo ""
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    echo ""
    echo "✓ CSP Team agents installed successfully!"
    echo ""
    echo "Next steps:"
    ...
    echo "  4. Start with: @csp_orchestrator: <your task>"
else
